  ...
  return (
    <>
      ...
      >
        ...
        <div className="row mt-3 h-lg-50 h-sm-30 h-20"> 
        ...
        <div className="row mt-lg-2 mt-1 h-10">
          <div className="col-12 p-0 d-flex justify-content-center align-items-center">
            <div className="fs-lg-7 fs-md-6 fs-sm-5 fs-4 title-font text-light">
              Where each Snack leaves an Impact
            </div>
          </div>
        </div>

        <div className="row mt-lg-2 mt-0 mx-auto py-2 w-100 h-10">
